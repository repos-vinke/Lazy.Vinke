// TestLazyJsonDeserializerDataTable.cs
//
...
{
    [TestClass]
    public class TestLazyJsonDeserializerDataTable
    {
        [TestMethod]
        ...
        public void TestDeserializerDataTablePropertyWithRowsAndColumnOptions()
        {
            ...
            deserializerOptions.Item<LazyJsonDeserializerOptionsDataTable>()["WithRows"].Columns["DateTime2"].Set(typeof(DateTime), new LazyJsonDeserializerDateTime());
