...
{
    [TestClass]
    public class TestLazyJsonDeserializer
    {
        [TestMethod]
        ...
        public void TestDeserializerSampleSimpleDateTime()
        {
            ...
            Assert.IsTrue(sampleSimpleDateTime.DateTimeValueValid.ToString(Globals.StringFormat.DateTime.ISO8601Z) == "2023-02-24T10:00:01:000Z");
        ...
        public void TestDeserializerSampleSimpleDataTable()
        {
            ...
            Assert.IsTrue(Convert.ToDateTime(sampleSimpleDataTable.DataTableWithSingleRow.Rows[0]["ColumnDateTime"]).ToString(Globals.StringFormat.DateTime.ISO8601Z) == "2022-02-22T11:52:02:000Z");
            ...
            Assert.IsTrue(Convert.ToDateTime(sampleSimpleDataTable.DataTableWithMultipleRows.Rows[0]["ColumnDateTime"]).ToString(Globals.StringFormat.DateTime.ISO8601Z) == "2023-03-23T11:53:03:000Z");
            ...
            Assert.IsTrue(Convert.ToDateTime(sampleSimpleDataTable.DataTableWithMultipleRows.Rows[1]["ColumnDateTime"]).ToString(Globals.StringFormat.DateTime.ISO8601Z) == "2024-04-24T11:54:04:000Z");
            ...
            Assert.IsTrue(Convert.ToDateTime(sampleSimpleDataTable.DataTableWithMultipleRows.Rows[2]["ColumnDateTime"]).ToString(Globals.StringFormat.DateTime.ISO8601Z) == "2025-05-25T11:55:05:000Z");
        }
        ...
        public void TestDeserializerSampleSimpleDataSet()
        {
            ...
            Assert.IsTrue(Convert.ToDateTime(dataTableWithSingleRow.Rows[0]["ColumnDateTime"]).ToString(Globals.StringFormat.DateTime.ISO8601Z) == "2022-02-22T11:52:02:000Z");
            ...
            Assert.IsTrue(Convert.ToDateTime(dataTableWithMultipleRows.Rows[0]["ColumnDateTime"]).ToString(Globals.StringFormat.DateTime.ISO8601Z) == "2023-03-23T11:53:03:000Z");
            ...
            Assert.IsTrue(Convert.ToDateTime(dataTableWithMultipleRows.Rows[1]["ColumnDateTime"]).ToString(Globals.StringFormat.DateTime.ISO8601Z) == "2024-04-24T11:54:04:000Z");
            ...
            Assert.IsTrue(Convert.ToDateTime(dataTableWithMultipleRows.Rows[2]["ColumnDateTime"]).ToString(Globals.StringFormat.DateTime.ISO8601Z) == "2025-05-25T11:55:05:000Z");
        }
